...
const values = [
  {
    ...
    description: 'Fostering creative problem-solving and cutting-edge solutions.',
    icon: RocketLaunchIcon,
  },
  {
    name: 'Building strong foundations.',
    description: 'Guiding entrepreneurs through business creation, strategy, and exit planning.',
    icon: HandRaisedIcon,
},
{
    name: 'Leveraging technology.',
    description: 'Utilizing technology to optimize operations and enhance brand experiences.',
    icon: SparklesIcon,
},
{
    name: 'Fostering collaboration.',
    description: 'Working hand-in-hand with clients to turn their visions into reality.',
    icon: UserGroupIcon,
  },
]
const team = [
      ...
      <main className="relative isolate">
        ...
        <div className="px-6 pt-14 lg:px-8">
          <div className="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Our Start-up Mission</h2>
