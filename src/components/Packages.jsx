  ...
  return (
    <div className="rounded-4xl bg-gray-50 py-20 sm:py-32">
      ...
      <div
        ...
        We offer flexible options for brands, individuals, and businesses of all sizes. Whether you are starting a new project or aiming for rapid growth, we have a plan that fits your goals.
        </p>
